...
import numpy as np
import pprint
from utils import build_emb_dict

glove_path = "C:/Users/t-linxli/Desktop/glove.twitter.27B.100d.txt"
src_path = "C:/Users/t-linxli/Desktop/out_rewrite.txt"
tgt_path = "C:/Users/t-linxli/Desktop/out_rewrite.txt"
    ...
    def trans_to_embs(self):
        with tf.variable_scope("Embedding"):
            if self.init_word_embs:
                ...
                emb_matrix = build_emb_dict(glove_path,src_path,tgt_path)
                self.W_emb = tf.constant(emb_matrix, name='W_emb', dtype=tf.float32)
